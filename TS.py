...
class SA():
    ...
    def Objfun(self, solution, show=False):
        ...
        if show == True:
            print("\n", "#" * 8,
                  "The Objective function value for {} solution schedule is: {}".format(solution, objfun_value),
                  "#" * 8)
        return objfun_value
    ...
    def SimuAnn(self):
        ...
        while T >= T_f:
            ...
            while epoch < maxepo:
                ...
                print("### iter: {}/ epoch: {} ### current_temp: {}, current_objfun: {}, best_Objfun: {}".format(
                    current_iter, epoch, T, current_objvalue, best_objvalue))
                ...
                if candidate_objvalue <= current_objvalue:
                    ...
                    print(" " * 5,
                          "Candidate Solution: Objfun= {},  Sequence= {}   =>  Improved Solution  => Accepted\n".format(
                              candidate_objvalue, candidate_solution))
                    ...
                    if x <= metropolis:
                        current_solution, current_objvalue = candidate_solution, candidate_objvalue
                        print(" " * 5,
                              "Candidate Solution: Objfun= {},  Sequence= {}   =>  Non_improved Solution => Metropolis => Accepted\n".format(
                                  candidate_objvalue, candidate_solution))
                    else:
                        print(" " * 5,
                              "Candidate Solution: Objfun= {},  Sequence= {}   =>  Non_improved Solution => Metropolis  => Not Accepted\n".format(
                                  candidate_objvalue, candidate_solution))
                        # Update param
                epoch += 1
            # Update Temp & iter
            ...
            current_iter += 1
        print('#' * 30,
              '\nNumber of iteration performed: {}\nFinal Temperature: {}\nBest Objvalue: {}\nBest Solution: {}'.format(
                  current_iter, T, best_objvalue, best_solution))
